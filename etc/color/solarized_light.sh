...
color05="d33682" # Base 0E - Magenta    # 6c71c4 ?
...
if [ -n "$ITERM_SESSION_ID" ]; then
    ...
    put_template_custom Pg $color_foreground # foreground
    put_template_custom Ph $color_background # background
    put_template_custom Pi $color_foreground # bold color
    put_template_custom Pj $color04 # selection color
    put_template_custom Pk $color00 # selected text color
