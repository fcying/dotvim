        ...
        config = function()
            vim.api.nvim_create_autocmd("Colorscheme", {
                ...
                callback = function()
                    ...
                    local guifg = string.format("#%x", hl_group.foreground)
                    local guibg = string.format("#%x", hl_group.background)
                    --print(vim.inspect(guifg))
                    --print(vim.inspect(guibg))
                    vim.cmd("highlight NvimTreeNormal guibg=" .. guibg .. " guifg=" .. guifg)
                end,
            })
